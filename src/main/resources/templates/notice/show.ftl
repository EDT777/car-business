            ...
            <div class="box box-primary">
                <div class="box-header with-border">
                    <div class="user-block">
                        ...
                        <span class="username"><a href="#">${notice.creator.name}</a></span>
                        <span class="description">${(notice.createTime?string('yyyy-MM-dd HH:mm:ss'))!}</span>
                    </div>
                    <div class="box-tools">
                    ...
                    <div class="timeline-item">
                        <span class="time"><i class="fa fa-clock-o"></i> 公告级别 ：${notice.getLevelName()}</span>
                    </div>
                </div>
